...
class TestVideoCacheManager(unittest.TestCase):
    """Verify that cache management only processes controlled files and completes lightweight statistics and cleanup based on metadata."""
    ...
    def test_stats_only_include_managed_top_level_regular_files(self):
        """
        Unknown files, nested files, and symbolic links may belong to the user and cannot be entered into capacity statistics or cleanup candidates.
        """
        now = 2_000_000_000.0
        ...
        try:
            ...
            # There may be no permission to create symbolic links when Windows developer mode is not turned on, which does not affect other assertions.
            pass
